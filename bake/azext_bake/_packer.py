...
def inject_choco_configure_provisioners(image_dir: Path):
    '''Injects the chocolatey configure provisioner into the packer build file'''
    _inject_provisioner(image_dir, PKR_PROVISIONER_CHOCO_CONFIGURE)
